...
class InstallData(InstallSystem):
    i = InstallSystem()

    i.get_install_message_handler(
        "Спасибо, что выбрали Неон!", "Thank you for choosing Neon!"
    )
    input()

    while True:
        user_name = i.get_install_input(
            "Как можно к Вам обращаться?", "How do I address you?"
        )
        if i.verify_install_data(
            ...
            while True:
                ...
                if i.verify_install_data(
                    ...
                    while True:
                        user_login = i.get_install_input(
                        ...
                        if i.verify_install_data(
                            ...
                            while True:
                                user_password = i.get_install_password(
                                ...
                                if i.verify_install_data(
                                    ...
                                    user_password_retry = i.get_install_password(
                                    ...
                                    if user_password != user_password_retry:
                                        ...
                                        while True:
                                            system_language = i.get_install_input(
                                            ...
                                            if i.verify_install_data(
                                                ...
                                                if i.verify_install_language(system_language):
                                                    i.get_install_message_handler(
